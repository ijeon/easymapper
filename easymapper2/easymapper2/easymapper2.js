...
var _unitIsRatio = new Boolean(true), // 단위 기본값(퍼센트) 여부
	_measureIsDrag = new Boolean(true), // 제도방식 기본값(드래그) 여부
	_theme; // 테마
...
function initAxis() {
	...
	axis_x_width = $axis_x.outerWidth(); // 눈금 길이
	...
	var iteration_x = Math.floor((_unitIsRatio ? 100 : axis_x_width) / scale_small); // 반복 횟수
